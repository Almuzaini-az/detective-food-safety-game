const { useState, useEffect } = React;
        ...
        function App() {
            ...
            return (
                ...
                {/* معلومات المطور للتواصل */}
                        <footer className="w-full text-center mt-auto pt-6 pb-4 pop-in">
                    ...
                    لتصميم وبرمجة ألعاب وتطبيقات تفاعلية مشابهة، تواصل مع المطور:
                                ...
                                <div className="flex flex-col items-center gap-3">
                                    <span className="font-bold text-white text-lg">عبدالعزيز فرج المزيني</span>
